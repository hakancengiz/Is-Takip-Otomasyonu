...
<div class="menu-baslik">Yeni Personel Ekleme Formu<br />
→<a style="color: #CC3;" href="index.php"> İşlem Ekranına Dön </a>←<br /><br />
</div>
<font color="#FFFFFF">
<form name="frm" action="personel-ekle.php" method="post" enctype="multipart/form-data">
...
if($btn)
{
	...
	$hedef="../resimler/personel/".$id.$_FILES["resim"]['name'];
	if(is_uploaded_file($fotograf))
	{
		...
		else
		{
			...
			mysql_query("insert into tbl_personel (ad_soyad,maas,fotograf,eposta,sifre,sorumlu_koordinator) values ('$adsoyad','$maas','$hedef','$eposta','$parola','$sorumlu_koordinator')") or die("- Personel eklenemedi.".mysql_error());
