...
<div class="menu">
<div class="menu-baslik">Sizin Emrinizdeki Personeller<br />
...
<?php
$uye_list=mysql_query("Select * from tbl_personel where sorumlu_koordinator=$id");
while($yaz=mysql_fetch_array($uye_list))
{
?>
	<tr>
    ...
    <td align="center"><a href='personel-duzenle.php?id=<?php echo $yaz['id']; ?>'>DÜZENLE</a></td>
    <td align="center"><a href='personel-sil.php?id=<?php echo $yaz['id']; ?>'>SİL</a></td>
    </tr>
    <tr>
    <td colspan="6"><hr /></td>
    </tr>
