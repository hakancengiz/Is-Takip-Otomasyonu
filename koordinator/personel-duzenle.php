...
<div class="menu">
<?php
$uye_list=mysql_query("Select * from tbl_personel where id=$personel_id");
...
if($btn)
{
	...
	if(!(empty($yenimaas)))
	{
		mysql_query("update tbl_personel set maas=$yenimaas where id=$personel_id")
		or 
		die("Veriler güncellenemedi.".mysql_error());
	
		echo "<font color='#FFF'>Güncelleme işlemi başarıyla gerçekleştirildi. <br/ >5 saniye sonra personel düzenleme alanına yönlendirileceksiniz.</font>";
		header("refresh:5;url=personel-listele.php");
	}
	else
	{
